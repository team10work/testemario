      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'balance',
            loadComponent: () =>
              import('./tabs/profile/balance/balance.page').then(
                (m) => m.BalancePage,
              ),
          },
          {
            path: 'edit-profile',
            loadComponent: () =>
              import('./tabs/profile/edit-profile/edit-profile.page').then(
                (m) => m.EditProfilePage,
              ),
          },
          {
            ...
            loadComponent: () =>
              import('./tabs/profile/edit-service/edit-service.page').then(
                (m) => m.EditServicePage,
              ),
          },
        ],
